import{c as b,u as z,j as e,l as E,L as x,r as y}from"./index-Cjc7yOxD.js";import{M}from"./map-pin-IXnU-FLk.js";import{P as F,M as _}from"./phone-CX_0Todn.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const q=b("CirclePlay",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polygon",{points:"10 8 16 12 10 16 10 8",key:"1cimsy"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const P=b("Instagram",[["rect",{width:"20",height:"20",x:"2",y:"2",rx:"5",ry:"5",key:"2e1cvw"}],["path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z",key:"9exkf1"}],["line",{x1:"17.5",x2:"17.51",y1:"6.5",y2:"6.5",key:"r4j83e"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R=b("Youtube",[["path",{d:"M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17",key:"1q2vi4"}],["path",{d:"m10 15 5-3-5-3z",key:"1jp15x"}]]),D="/assets/honey-footer-BrnrYwdJ.webp",W="/assets/scene-F8nsAT0c.mp4",S="/assets/scene-CtjW0hyU.webm",B=()=>{const t=y.useRef(null),n=y.useRef(null);return y.useEffect(()=>{const r=t.current,a=n.current,c=a==null?void 0:a.getContext("2d",{willReadFrequently:!0});if(!r||!a||!c)return;let o=0,l=!1,h=!1,p=!1;const v=()=>{if(!r.videoWidth)return;const d=Math.min(1,300/r.videoWidth),s=Math.round(r.videoWidth*d),i=Math.round(r.videoHeight*d);(a.width!==s||a.height!==i)&&(a.width=s,a.height=i)},g=()=>{if(!(p||!r.videoWidth)){v(),c.drawImage(r,0,0,a.width,a.height);try{const d=c.getImageData(0,0,a.width,a.height),s=d.data;for(let i=0;i<s.length;i+=4){const C=s[i],L=s[i+1],I=s[i+2],u=.2126*C+.7152*L+.0722*I;s[i+3]=u<=18?0:u>=70?255:Math.round((u-18)/52*255)}c.putImageData(d,0,0),a.style.opacity!=="1"&&(a.style.opacity="1")}catch{p=!0}}},k=()=>{o=0,g(),l&&h&&!p&&(o=requestAnimationFrame(k))},f=()=>{l&&h&&!p?o||(o=requestAnimationFrame(k)):o&&(cancelAnimationFrame(o),o=0)},j=()=>{l=!0,f()},w=()=>{l=!1,f()},m=typeof IntersectionObserver<"u"?new IntersectionObserver(d=>{d.forEach(s=>{h=s.isIntersecting,f()})},{rootMargin:"100px"}):null;m?m.observe(a):h=!0,a.style.opacity="0";const N=()=>{v(),g()};r.addEventListener("play",j),r.addEventListener("pause",w),r.addEventListener("loadeddata",g),r.addEventListener("loadedmetadata",N);const A=r.play();return A&&A.catch(()=>{}),()=>{o&&cancelAnimationFrame(o),m==null||m.disconnect(),r.removeEventListener("play",j),r.removeEventListener("pause",w),r.removeEventListener("loadeddata",g),r.removeEventListener("loadedmetadata",N)}},[]),e.jsxs("span",{className:"northmad-badge",children:[e.jsxs("video",{ref:t,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"northmad-video select-none pointer-events-none","aria-label":"Northmad",tabIndex:-1,children:[e.jsx("source",{src:S,type:"video/webm"}),e.jsx("source",{src:W,type:"video/mp4"})]}),e.jsx("canvas",{ref:n,className:"northmad-video-canvas select-none pointer-events-none","aria-hidden":"true"})]})},T=()=>{const{t}=z(),n=o=>{const l=document.getElementById(o);l&&l.scrollIntoView({behavior:"smooth"})},r=o=>{const h=`https://wa.me/6282347905543?text=${encodeURIComponent(o)}`;window.open(h,"_blank")},a=[{icon:M,label:t("contact.address"),href:"https://www.google.com/maps/search/?api=1&query=South+Sulawesi+Indonesia"},{icon:F,label:"+62 823 4790 5543",href:"tel:+6282347905543"},{icon:_,label:"lontarajayanusantara@",href:"mailto:lontarajayanusantara@gmail.com"}],c=[{icon:P,href:"https://instagram.com/maduhutanlontara",label:t("footer.social.instagram")},{icon:q,href:"https://tiktok.com/@maduhutanlontara",label:t("footer.social.tiktok")},{icon:R,href:"https://youtube.com/@rajamadusulawesi7380",label:t("footer.social.youtube")}];return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .northmad-credit {
          display: flex;
