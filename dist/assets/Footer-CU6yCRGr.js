import{c as y,u as z,j as e,l as L,L as x,r as u}from"./index-El0TLcqf.js";import{M as E}from"./map-pin-DyD7maCI.js";import{P as M,M as F}from"./phone-YOYgzTEc.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _=y("CirclePlay",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polygon",{points:"10 8 16 12 10 16 10 8",key:"1cimsy"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const q=y("Instagram",[["rect",{width:"20",height:"20",x:"2",y:"2",rx:"5",ry:"5",key:"2e1cvw"}],["path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z",key:"9exkf1"}],["line",{x1:"17.5",x2:"17.51",y1:"6.5",y2:"6.5",key:"r4j83e"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const P=y("Youtube",[["path",{d:"M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17",key:"1q2vi4"}],["path",{d:"m10 15 5-3-5-3z",key:"1jp15x"}]]),N="/assets/honey-footer-BrnrYwdJ.webp",R="/assets/scene-F8nsAT0c.mp4",W="/assets/scene-CtjW0hyU.webm",S=()=>{const t=u.useRef(null),n=u.useRef(null);return u.useEffect(()=>{const r=t.current,a=n.current,c=a==null?void 0:a.getContext("2d",{willReadFrequently:!0});if(!r||!a||!c)return;let o=0,i=!1,h=!1,p=!1;const A=()=>{if(!r.videoWidth)return;const d=Math.min(1,400/r.videoWidth),s=Math.round(r.videoWidth*d),l=Math.round(r.videoHeight*d);(a.width!==s||a.height!==l)&&(a.width=s,a.height=l)},g=()=>{if(!(p||!r.videoWidth)){A(),c.drawImage(r,0,0,a.width,a.height);try{const d=c.getImageData(0,0,a.width,a.height),s=d.data;for(let l=0;l<s.length;l+=4){const D=s[l],C=s[l+1],I=s[l+2],w=.2126*D+.7152*C+.0722*I;s[l+3]=w<18?0:Math.min(255,w*1.4)}c.putImageData(d,0,0)}catch{p=!0}}},b=()=>{o=0,g(),i&&h&&!p&&(o=requestAnimationFrame(b))},f=()=>{i&&h&&!p?o||(o=requestAnimationFrame(b)):o&&(cancelAnimationFrame(o),o=0)},v=()=>{i=!0,f()},k=()=>{i=!1,f()},m=typeof IntersectionObserver<"u"?new IntersectionObserver(d=>{d.forEach(s=>{h=s.isIntersecting,f()})},{rootMargin:"100px"}):null;m?m.observe(a):h=!0,r.addEventListener("play",v),r.addEventListener("pause",k),r.addEventListener("loadeddata",g);const j=r.play();return j&&j.catch(()=>{}),()=>{o&&cancelAnimationFrame(o),m==null||m.disconnect(),r.removeEventListener("play",v),r.removeEventListener("pause",k),r.removeEventListener("loadeddata",g)}},[]),e.jsxs("span",{className:"northmad-badge",children:[e.jsxs("video",{ref:t,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"northmad-video select-none pointer-events-none","aria-label":"Northmad",tabIndex:-1,children:[e.jsx("source",{src:W,type:"video/webm"}),e.jsx("source",{src:R,type:"video/mp4"})]}),e.jsx("canvas",{ref:n,className:"northmad-video-canvas select-none pointer-events-none","aria-hidden":"true"})]})},Y=()=>{const{t}=z(),n=o=>{const i=document.getElementById(o);i&&i.scrollIntoView({behavior:"smooth"})},r=o=>{const h=`https://wa.me/6282347905543?text=${encodeURIComponent(o)}`;window.open(h,"_blank")},a=[{icon:E,label:t("contact.address"),href:"https://www.google.com/maps/search/?api=1&query=South+Sulawesi+Indonesia"},{icon:M,label:"+62 823 4790 5543",href:"tel:+6282347905543"},{icon:F,label:"lontarajayanusantara@",href:"mailto:lontarajayanusantara@gmail.com"}],c=[{icon:q,href:"https://instagram.com/maduhutanlontara",label:t("footer.social.instagram")},{icon:_,href:"https://tiktok.com/@maduhutanlontara",label:t("footer.social.tiktok")},{icon:P,href:"https://youtube.com/@rajamadusulawesi7380",label:t("footer.social.youtube")}];return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .northmad-credit {
          display: flex;
