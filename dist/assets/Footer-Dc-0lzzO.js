import{c as N,u as q,j as e,l as S,L as g,r as j}from"./index-DVSwRq-u.js";import{M as W}from"./map-pin-B-139WFb.js";import{P as _,M as P}from"./phone-Do07ggFv.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const B=N("CirclePlay",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polygon",{points:"10 8 16 12 10 16 10 8",key:"1cimsy"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const O=N("Instagram",[["rect",{width:"20",height:"20",x:"2",y:"2",rx:"5",ry:"5",key:"2e1cvw"}],["path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z",key:"9exkf1"}],["line",{x1:"17.5",x2:"17.51",y1:"6.5",y2:"6.5",key:"r4j83e"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const V=N("Youtube",[["path",{d:"M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17",key:"1q2vi4"}],["path",{d:"m10 15 5-3-5-3z",key:"1jp15x"}]]),E="/assets/honey-footer-BrnrYwdJ.webp",Y="/assets/scene-F8nsAT0c.mp4",H="/assets/scene-CtjW0hyU.webm",T=()=>{const t=j.useRef(null),n=j.useRef(null);return j.useEffect(()=>{const r=t.current,a=n.current,l=a==null?void 0:a.getContext("2d",{willReadFrequently:!0});if(!r||!a||!l)return;const o=document.createElement("canvas"),d=o.getContext("2d",{willReadFrequently:!0});if(!d)return;let s=0,f=!1,u=!1,y=!1;const A=()=>{if(!r.videoWidth)return;const c=Math.min(1,300/r.videoWidth),i=Math.round(r.videoWidth*c),h=Math.round(r.videoHeight*c);(a.width!==i||a.height!==h)&&(a.width=i,a.height=h)},b=()=>{if(y||!r.videoWidth)return;A();const c=160/r.videoWidth,i=Math.max(24,Math.round(r.videoWidth*c)),h=Math.max(24,Math.round(r.videoHeight*c));o.width!==i&&(o.width=i,o.height=h),d.drawImage(r,0,0,i,h);try{const k=d.getImageData(0,0,i,h),p=k.data;for(let m=0;m<p.length;m+=4){const z=p[m],F=p[m+1],R=p[m+2],w=.2126*z+.7152*F+.0722*R;p[m+3]=w<=45?0:w>=100?255:Math.round((w-45)/55*255)}d.putImageData(k,0,0),l.imageSmoothingEnabled=!0,l.imageSmoothingQuality="high",l.clearRect(0,0,a.width,a.height),l.drawImage(o,0,0,a.width,a.height),a.style.opacity!=="1"&&(a.style.opacity="1")}catch{y=!0}},D=()=>{s=0,b(),f&&u&&!y&&(s=requestAnimationFrame(D))},v=()=>{f&&u&&!y?s||(s=requestAnimationFrame(D)):s&&(cancelAnimationFrame(s),s=0)},C=()=>{f=!0,v()},I=()=>{f=!1,v()},x=typeof IntersectionObserver<"u"?new IntersectionObserver(c=>{c.forEach(i=>{u=i.isIntersecting,v()})},{rootMargin:"100px"}):null;x?x.observe(a):u=!0,a.style.opacity="0";const L=()=>{A(),b()};r.addEventListener("play",C),r.addEventListener("pause",I),r.addEventListener("loadeddata",b),r.addEventListener("loadedmetadata",L);const M=r.play();return M&&M.catch(()=>{}),()=>{s&&cancelAnimationFrame(s),x==null||x.disconnect(),r.removeEventListener("play",C),r.removeEventListener("pause",I),r.removeEventListener("loadeddata",b),r.removeEventListener("loadedmetadata",L)}},[]),e.jsxs("span",{className:"northmad-badge",children:[e.jsxs("video",{ref:t,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"northmad-video select-none pointer-events-none","aria-label":"Northmad",tabIndex:-1,children:[e.jsx("source",{src:H,type:"video/webm"}),e.jsx("source",{src:Y,type:"video/mp4"})]}),e.jsx("canvas",{ref:n,className:"northmad-video-canvas select-none pointer-events-none","aria-hidden":"true"})]})},Q=()=>{const{t}=q(),n=o=>{const d=document.getElementById(o);d&&d.scrollIntoView({behavior:"smooth"})},r=o=>{const s=`https://wa.me/6282347905543?text=${encodeURIComponent(o)}`;window.open(s,"_blank")},a=[{icon:W,label:t("contact.address"),href:"https://www.google.com/maps/search/?api=1&query=South+Sulawesi+Indonesia"},{icon:_,label:"+62 823 4790 5543",href:"tel:+6282347905543"},{icon:P,label:"lontarajayanusantara@",href:"mailto:lontarajayanusantara@gmail.com"}],l=[{icon:O,href:"https://instagram.com/maduhutanlontara",label:t("footer.social.instagram")},{icon:B,href:"https://tiktok.com/@maduhutanlontara",label:t("footer.social.tiktok")},{icon:V,href:"https://youtube.com/@rajamadusulawesi7380",label:t("footer.social.youtube")}];return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .northmad-credit {
          display: flex;
