import{c as L,u as q,j as e,l as W,L as u,r as A}from"./index-D5dzcHEa.js";import{M as V}from"./map-pin-DinSpgif.js";import{P as B,M as O}from"./phone-B4pseINn.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Y=L("CirclePlay",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polygon",{points:"10 8 16 12 10 16 10 8",key:"1cimsy"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const H=L("Instagram",[["rect",{width:"20",height:"20",x:"2",y:"2",rx:"5",ry:"5",key:"2e1cvw"}],["path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z",key:"9exkf1"}],["line",{x1:"17.5",x2:"17.51",y1:"6.5",y2:"6.5",key:"r4j83e"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T=L("Youtube",[["path",{d:"M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17",key:"1q2vi4"}],["path",{d:"m10 15 5-3-5-3z",key:"1jp15x"}]]),z="/assets/honey-footer-BrnrYwdJ.webp",F="/assets/scene-F8nsAT0c.mp4",S="/assets/scene-CtjW0hyU.webm",U=()=>e.jsxs("video",{autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"northmad-video select-none pointer-events-none","aria-label":"Northmad",tabIndex:-1,children:[e.jsx("source",{src:S,type:"video/webm"}),e.jsx("source",{src:F,type:"video/mp4"})]}),$=typeof navigator<"u"&&/^((?!chrome|android|crios|fxios|edg|opr|samsung).)*safari/i.test(navigator.userAgent),J=()=>{const t=A.useRef(null),n=A.useRef(null);return A.useEffect(()=>{const r=t.current,a=n.current,c=a==null?void 0:a.getContext("2d",{willReadFrequently:!0});if(!r||!a||!c)return;const o=document.createElement("canvas"),h=o.getContext("2d",{willReadFrequently:!0});if(!h)return;let s=0,f=!1,y=!1,v=!1;const E=()=>{if(!r.videoWidth)return;const i=Math.min(1,300/r.videoWidth),d=Math.round(r.videoWidth*i),m=Math.round(r.videoHeight*i);(a.width!==d||a.height!==m)&&(a.width=d,a.height=m)},b=()=>{if(v||!r.videoWidth)return;E();const i=160/r.videoWidth,d=Math.max(24,Math.round(r.videoWidth*i)),m=Math.max(24,Math.round(r.videoHeight*i));o.width!==d&&(o.width=d,o.height=m),h.drawImage(r,0,0,d,m);try{const j=h.getImageData(0,0,d,m),g=j.data;for(let x=0;x<g.length;x+=4){const R=g[x],P=g[x+1],_=g[x+2],N=.2126*R+.7152*P+.0722*_;g[x+3]=N<=45?0:N>=100?255:Math.round((N-45)/55*255)}h.putImageData(j,0,0),c.imageSmoothingEnabled=!0,c.imageSmoothingQuality="high",c.clearRect(0,0,a.width,a.height),c.drawImage(o,0,0,a.width,a.height),a.style.opacity!=="1"&&(a.style.opacity="1")}catch{v=!0}},I=()=>{s=0,b(),f&&y&&!v&&(s=requestAnimationFrame(I))},w=()=>{f&&y&&!v?s||(s=requestAnimationFrame(I)):s&&(cancelAnimationFrame(s),s=0)},k=()=>{const i=r.play();i&&i.catch(()=>{})},D=()=>{f=!0,w()},C=()=>{f=!1,w()},p=typeof IntersectionObserver<"u"?new IntersectionObserver(i=>{i.forEach(d=>{y=d.isIntersecting,w()})},{rootMargin:"100px"}):null;p?p.observe(a):y=!0,a.style.opacity="0";const M=()=>{E(),b()};r.addEventListener("play",D),r.addEventListener("pause",C),r.addEventListener("loadeddata",b),r.addEventListener("loadedmetadata",M),r.addEventListener("canplay",k),k();const l=()=>{k(),document.removeEventListener("pointerdown",l),document.removeEventListener("keydown",l),document.removeEventListener("touchstart",l)};return document.addEventListener("pointerdown",l),document.addEventListener("keydown",l),document.addEventListener("touchstart",l),()=>{s&&cancelAnimationFrame(s),p==null||p.disconnect(),document.removeEventListener("pointerdown",l),document.removeEventListener("keydown",l),document.removeEventListener("touchstart",l),r.removeEventListener("play",D),r.removeEventListener("pause",C),r.removeEventListener("loadeddata",b),r.removeEventListener("loadedmetadata",M),r.removeEventListener("canplay",k)}},[]),e.jsxs("span",{className:"safari-northmad-badge",children:[e.jsxs("video",{ref:t,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,preload:"auto",className:"safari-northmad-video-source select-none pointer-events-none",tabIndex:-1,children:[e.jsx("source",{src:F,type:"video/mp4"}),e.jsx("source",{src:S,type:"video/webm"})]}),e.jsx("canvas",{ref:n,className:"safari-northmad-video select-none pointer-events-none","aria-hidden":"true"})]})},X=()=>{const{t}=q(),n=o=>{const h=document.getElementById(o);h&&h.scrollIntoView({behavior:"smooth"})},r=o=>{const s=`https://wa.me/6282347905543?text=${encodeURIComponent(o)}`;window.open(s,"_blank")},a=[{icon:V,label:t("contact.address"),href:"https://www.google.com/maps/search/?api=1&query=South+Sulawesi+Indonesia"},{icon:B,label:"+62 823 4790 5543",href:"tel:+6282347905543"},{icon:O,label:"lontarajayanusantara@",href:"mailto:lontarajayanusantara@gmail.com"}],c=[{icon:H,href:"https://instagram.com/maduhutanlontara",label:t("footer.social.instagram")},{icon:Y,href:"https://tiktok.com/@maduhutanlontara",label:t("footer.social.tiktok")},{icon:T,href:"https://youtube.com/@rajamadusulawesi7380",label:t("footer.social.youtube")}];return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .northmad-credit {
          display: flex;
