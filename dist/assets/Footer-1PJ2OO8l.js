import{c as n,j as e,l as h,L as r}from"./index-B19PsSUE.js";import{M as m}from"./map-pin-C-R_H0Uk.js";import{P as x,M as p}from"./phone-CfvGQXwL.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const u=n("Youtube",[["path",{d:"M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17",key:"1q2vi4"}],["path",{d:"m10 15 5-3-5-3z",key:"1jp15x"}]]),d="/assets/honey-footer-BrnrYwdJ.webp",b="/assets/scene-F8nsAT0c.mp4",f="/assets/scene-CtjW0hyU.webm",w=()=>{const t=o=>{const a=document.getElementById(o);a&&a.scrollIntoView({behavior:"smooth"})},s=o=>{const c=`https://wa.me/6282347905543?text=${encodeURIComponent(o)}`;window.open(c,"_blank")},l=[{icon:m,label:"South Sulawesi, Indonesia",href:"https://www.google.com/maps/search/?api=1&query=South+Sulawesi+Indonesia"},{icon:x,label:"+62 823 4790 5543",href:"tel:+6282347905543"},{icon:p,label:"lontarajayanusantara@",href:"mailto:lontarajayanusantara@gmail.com"}],i=[{icon:y,href:"https://instagram.com/maduhutanlontara",label:"Instagram"},{icon:g,href:"https://tiktok.com/@maduhutanlontara",label:"TikTok"},{icon:u,href:"https://youtube.com/@rajamadusulawesi7380",label:"YouTube"}];return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .northmad-credit {
          display: flex;
