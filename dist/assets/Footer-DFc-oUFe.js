import{c as f,j as e,l as L,L as m,r as u}from"./index-gcmXamms.js";import{M as P}from"./map-pin-UcwvA1tz.js";import{P as z,M as E}from"./phone-BLdsEB7x.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const F=f("Instagram",[["rect",{width:"20",height:"20",x:"2",y:"2",rx:"5",ry:"5",key:"2e1cvw"}],["path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z",key:"9exkf1"}],["line",{x1:"17.5",x2:"17.51",y1:"6.5",y2:"6.5",key:"r4j83e"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const M=f("Youtube",[["path",{d:"M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17",key:"1q2vi4"}],["path",{d:"m10 15 5-3-5-3z",key:"1jp15x"}]]),w="/assets/honey-footer-BrnrYwdJ.webp",R="/assets/scene-F8nsAT0c.mp4",H="/assets/scene-CtjW0hyU.webm",W=()=>{const n=u.useRef(null),c=u.useRef(null);return u.useEffect(()=>{const r=n.current,o=c.current,t=o==null?void 0:o.getContext("2d",{willReadFrequently:!0});if(!r||!o||!t)return;let a=0,d=!1,x=!1,p=!1;const N=()=>{if(!r.videoWidth)return;const i=Math.min(1,400/r.videoWidth),s=Math.round(r.videoWidth*i),l=Math.round(r.videoHeight*i);(o.width!==s||o.height!==l)&&(o.width=s,o.height=l)},A=()=>{if(!(p||!r.videoWidth)){N(),t.drawImage(r,0,0,o.width,o.height);try{const i=t.getImageData(0,0,o.width,o.height),s=i.data;for(let l=0;l<s.length;l+=4){const I=s[l],D=s[l+1],C=s[l+2],j=.2126*I+.7152*D+.0722*C;s[l+3]=j<18?0:Math.min(255,j*1.4)}t.putImageData(i,0,0)}catch{p=!0}}},y=()=>{a=0,A(),d&&x&&!p&&(a=requestAnimationFrame(y))},g=()=>{d&&x&&!p?a||(a=requestAnimationFrame(y)):a&&(cancelAnimationFrame(a),a=0)},b=()=>{d=!0,g()},v=()=>{d=!1,g()},h=typeof IntersectionObserver<"u"?new IntersectionObserver(i=>{i.forEach(s=>{x=s.isIntersecting,g()})},{rootMargin:"100px"}):null;h?h.observe(o):x=!0,r.addEventListener("play",b),r.addEventListener("pause",v);const k=r.play();return k&&k.catch(()=>{}),()=>{a&&cancelAnimationFrame(a),h==null||h.disconnect(),r.removeEventListener("play",b),r.removeEventListener("pause",v)}},[]),e.jsxs(e.Fragment,{children:[e.jsxs("video",{ref:n,autoPlay:!0,loop:!0,muted:!0,playsInline:!0,className:"northmad-video select-none pointer-events-none","aria-label":"Northmad",tabIndex:-1,children:[e.jsx("source",{src:H,type:"video/webm"}),e.jsx("source",{src:R,type:"video/mp4"})]}),e.jsx("canvas",{ref:c,className:"northmad-video-canvas select-none pointer-events-none","aria-hidden":"true"})]})},Y=()=>{const n=t=>{const a=document.getElementById(t);a&&a.scrollIntoView({behavior:"smooth"})},c=t=>{const d=`https://wa.me/6282347905543?text=${encodeURIComponent(t)}`;window.open(d,"_blank")},r=[{icon:P,label:"South Sulawesi, Indonesia",href:"https://www.google.com/maps/search/?api=1&query=South+Sulawesi+Indonesia"},{icon:z,label:"+62 823 4790 5543",href:"tel:+6282347905543"},{icon:E,label:"lontarajayanusantara@",href:"mailto:lontarajayanusantara@gmail.com"}],o=[{icon:F,href:"https://instagram.com/maduhutanlontara",label:"Instagram"},{icon:S,href:"https://tiktok.com/@maduhutanlontara",label:"TikTok"},{icon:M,href:"https://youtube.com/@rajamadusulawesi7380",label:"YouTube"}];return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .northmad-credit {
          display: flex;
