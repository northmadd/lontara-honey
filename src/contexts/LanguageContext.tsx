...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'testimonials.1.role': 'Professional Designer',
    'testimonials.1.text': 'The best honey I\'ve ever tasted! Authentic flavor and exceptional quality.',
    'testimonials.2.role': 'The Baba Yaga',
    'testimonials.2.text': 'Lontara Honey is the main choice to keep my body healthy. WOAW!!',
    'testimonials.3.role': 'Business Founder',
    'testimonials.3.text': 'My family very loves this honey! Kids now prefer honey over sugar.',
    ...
    'legal.privacy.s1.text': 'We collect the name, telephone number, country code, and message you submit through our contact and order forms.',
    ...
    'legal.faq.s2.text': 'Bank Mandiri transfer is currently available. PayPal is coming soon.',
  ...
  id: {
    ...
    'testimonials.1.role': 'Desainer Profesional',
    'testimonials.1.text': 'Madu terbaik yang pernah saya coba! Rasanya autentik dan kualitasnya luar biasa.',
    'testimonials.2.role': 'The Baba Yaga',
    'testimonials.2.text': 'Lontara Honey adalah pilihan utama untuk membuat tubuh saya selalu terjaga manfaatnya WOAW!!',
    'testimonials.3.role': 'Pendiri Bisnis',
    'testimonials.3.text': 'Keluarga saya sangat menyukai madu ini! Anak-anak sekarang lebih suka madu daripada gula.',
    ...
    'legal.privacy.s1.text': 'Kami mengumpulkan nama, nomor telepon, kode negara, dan pesan yang Anda kirim melalui formulir kontak dan pemesanan kami.',
    ...
    'legal.faq.s2.text': 'Transfer Bank Mandiri saat ini tersedia. PayPal segera hadir.',
