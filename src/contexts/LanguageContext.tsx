...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'order.map.hint': 'Search a place or shop name, then pick a pin on the map or from the result list — the selected address is copied and filled in automatically.',
    ...
    'order.map.noResult': 'No results found. Try another keyword, or click directly on the map to pick a point.',
  ...
  id: {
    ...
    'order.map.hint': 'Cari nama tempat/toko, lalu pilih pin di peta atau dari daftar hasil — alamat yang dipilih otomatis disalin dan diisi ke kolom Alamat di atas.',
    ...
    'order.map.noResult': 'Tidak ada hasil ditemukan. Coba kata kunci lain, atau klik langsung di peta untuk memilih titik.',
