...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'order.map.title': 'Locate on Google Maps',
    'order.map.hint': 'Find your location in the map, copy the address shown by Google Maps, then paste it into the Address field above.',
    'order.map.open': 'Open in Google Maps',
    'order.map.copy': 'Copy Store Address',
    'order.map.copied': 'Address copied — paste it into the Address field above.',
    'order.map.search': 'Search address or place...',
    'order.map.searchBtn': 'Search',
    'order.map.resolving': 'Searching address... ',
  ...
  id: {
    ...
    'order.map.title': 'Cari Lokasi di Google Maps',
    'order.map.hint': 'Cari lokasi kamu di peta, salin alamat yang tampil di Google Maps, lalu tempel ke kolom Alamat di atas.',
    'order.map.open': 'Buka di Google Maps',
    'order.map.copy': 'Salin Alamat Toko',
    'order.map.copied': 'Alamat disalin — tempel ke kolom Alamat di atas.',
    'order.map.search': 'Cari alamat atau tempat...',
    'order.map.searchBtn': 'Cari',
    'order.map.resolving': 'Mencari alamat... ',
