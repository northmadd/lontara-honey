...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'order.addressMapsHint': 'Click the map or search to set your delivery location.',
    'order.storeButton': 'Our Store Location',
    'order.storeAddress': 'Jl. Pangkabinanga, Pangkabinanga, Pallangga, Gowa, Sulawesi Selatan 92161',
    'order.map.title': 'Select Delivery Location',
    'order.map.searchPlaceholder': 'Search location...',
    'order.map.search': 'Search',
    'order.map.searching': 'Searching...',
    'order.map.finding': 'Getting address...',
    'order.map.error': 'Location not found. Try another keyword.',
    'order.map.hint': 'Tip: you can also click directly on the map to set the location.',
    'order.qris.expires': 'QRIS session expires in',
    'order.qris.scan': 'Scan this QR with your e-wallet or mobile banking app.',
    'order.qris.proofReminder': 'IMPORTANT: Sending your payment proof via WhatsApp is MANDATORY after paying. Orders without proof will not be processed.',
    'order.qris.confirm': 'I have completed the payment and will send the transfer proof via WhatsApp.',
    'order.qris.proofRequired': 'Please confirm that you have paid and will send the proof.',
    ...
    'order.wa.qris.note': 'Payment proof: will be sent via WhatsApp',
  ...
  id: {
    ...
    'order.addressMapsHint': 'Klik peta atau cari untuk mengatur alamat pengiriman.',
    'order.storeButton': 'Lokasi Toko Kami',
    'order.storeAddress': 'Jl. Pangkabinanga, Pangkabinanga, Pallangga, Gowa, Sulawesi Selatan 92161',
    'order.map.title': 'Pilih Lokasi Pengiriman',
    'order.map.searchPlaceholder': 'Cari lokasi...',
    'order.map.search': 'Cari',
    'order.map.searching': 'Mencari...',
    'order.map.finding': 'Mengambil alamat...',
    'order.map.error': 'Lokasi tidak ditemukan. Coba kata kunci lain.',
    'order.map.hint': 'Tips: Anda juga bisa klik langsung di peta untuk menentukan lokasi.',
    'order.qris.expires': 'Sesi QRIS berakhir dalam',
    'order.qris.scan': 'Pindai QR ini dengan e-wallet atau m-banking Anda.',
    'order.qris.proofReminder': 'PENTING: Mengirim bukti transfer via WhatsApp WAJIB dilakukan setelah membayar. Pesanan tanpa bukti tidak akan diproses.',
    'order.qris.confirm': 'Saya sudah melakukan pembayaran dan akan mengirim bukti transfer via WhatsApp.',
    'order.qris.proofRequired': 'Silakan konfirmasi bahwa Anda sudah membayar dan akan mengirim buktinya.',
    ...
    'order.wa.qris.note': 'Bukti pembayaran: akan dikirim via WhatsApp',
